...
Feature: Meetings
  ...
  Scenario: Remove a meeting
    Given I navigate to Schedule page
    And I create successfully a meeting with the following information: "jhasmany.quiroz", "Meeting #3", "22:05", "22:10", "", "This is a message"
  ...
  Examples:
    | Organizer       | Subject             | From    | To      | Attendees | Body                  | Message                 |
    |                 | Meeting #4          | 22:10   | 22:15   |           | This is a message     | Organizer is required   |
...
#    And the meeting should be listed in the meetings of Room using the API
  ...
  Scenario: Try to create a meeting at the same time than other meeting
    Given I navigate to Schedule page
    And I create successfully a meeting with the following information: "jhasmany.quiroz", "Meeting #5", "22:20", "22:25", "", "This is a message"
    And an information message should be displayed "Meeting successfully created"
    When I create successfully a meeting with the following information: "jhasmany.quiroz", "Meeting #6", "22:20", "22:25", "", "This is a message"
