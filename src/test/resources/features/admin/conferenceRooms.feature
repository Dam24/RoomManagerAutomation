...
@Rooms
Feature: Rooms
>>>>>>> 6c126b32f0186f7b0bae1a6931264ebbb867f099
  ...
  @AssignResource
  Scenario Outline: User should be able Assign to Resources to Conference Room
    Given I create a resource with the following dates: "<Resource Name>"
    And I navigate to Conference Rooms page
    And I displayed the Resource in the Conference Room's Table
    When I associate the Resource to the "<Room Display Name>" Conference Room with quantity "<Quantity>"
    Then the "<Message>" message should be displayed
    And the Resource should be displayed with quantity "<Quantity>" for the Conference Room
    And the Resource association should be obtained using the API for Conference Room

  Examples:
    |Resource Name    |Quantity |Room Display Name        |Message                     |
    |Printer          |5        |Floor1Room19             |Room successfully Modified  |
